...
export default class LookupLwc extends LightningElement {
    ...
    connectedCallback() {
        ...
        this.respectSharing = !this.withoutSharing;
    }
    ...
    @wire(lookUp, { searchTerm: '$searchTerm', objectName: '$objName', filters: '$filters', fields: '$displayFields', respectSharing: '$respectSharing'})
